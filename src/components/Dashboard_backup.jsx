          ...
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:3 }}>
                ...
                {d.pChange >= 0
                  ? <span className="badge badge-bull">▲ {d.pChange.toFixed(2)}%</span>
                  : <span className="badge badge-bear">▼ {Math.abs(d.pChange).toFixed(2)}%</span>}
              </div>
          ...
          {activeTab === 'overview' && (
            <div>
              ...
              <div className="chart-wrap">
                ...
                {chartMode === 'daily' ? (
                  <AreaChart history={activeHistory} />
                ) : (
                  <>
              ...
              <div className="stat-grid-3" style={{marginBottom:10}}>
                ...
                <div className="stat-box">
                  ...
                  <div className="stat-box-value" style={{fontSize:12}}>{d.volume.toLocaleString()}</div>
                </div>
                <div className="stat-box">
              ...
              <div style={{ background:signal.bg, border:`1px solid ${signal.color}30`, borderRadius:14, padding:14, marginBottom:10 }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:6, marginTop:10 }}>
                  {[
                    ['EMA20', `Rs.${fmt(d.ema20)}`],
                    ['EMA50', `Rs.${fmt(d.ema50)}`],
                    ['MACD Line', d.macd.line.toFixed(3)],
                    ['MACD Signal', d.macd.signal.toFixed(3)],
                  ].map(([l,v]) => (
